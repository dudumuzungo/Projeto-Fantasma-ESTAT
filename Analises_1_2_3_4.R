...
tabela_preco_aval <- table(vendas2$Price, vendas2$Rating)
tabela_preco_aval

cor_preco_aval <- assocstats(tabela_preco_aval)
cor_preco_aval
# Coeficiente de contingência alto = 0,994. Quanto maior o preço, amior a avaliação